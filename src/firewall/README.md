...
```json
"features": {
    "ghcr.io/fohrloop/devcontainer-features/firewall:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/fohrloop/devcontainer-features/blob/main/src/firewall/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
